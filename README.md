...
- **Real-time Visualization**: High-performance canvas-based cava-style audio spectrum rendering.
...
- **Audio Processing**: Web Audio API + cava-style analysis (`src/utils/audioMath.ts`: plan/state, time-domain frames, sensitivity/autosens/noise reduction)
