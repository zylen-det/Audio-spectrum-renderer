          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <h3
                  className={`text-base font-medium w-[20ch] truncate ${currentFileId === file.id ? "text-white" : "text-zinc-300"}`}
                >
                  {file.name}
                </h3>
                <div className="flex items-center gap-3 mt-1 test-sm text-zinc-500">
