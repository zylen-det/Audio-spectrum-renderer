      ...
      <div className="absolute top-0 w-full flex flex-col items-center pointer-events-none px-2 sm:px-4">
        <AnimatePresence>
          <motion.div
            ...
            className="pointer-events-auto border border-zinc-700 rounded-3xl p-3 sm:p-6 shadow-2xl max-w-[1800px] w-full flex flex-col gap-3 sm:gap-4 backdrop-blur-md bg-zinc-950/80 max-h-[90vh] sm:max-h-none overflow-y-auto sm:overflow-visible"
          >
            {/* 頂部控制欄 - 手機垂直，桌面水平 */}
